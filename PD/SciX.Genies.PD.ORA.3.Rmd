...
plot(cluster)
cluster.result <- cutree(cluster, k=3)
...
targets = data.frame(group = gsub('_[0-9]+', '', metadata$condition),
                    sex = metadata$sex,
                    age = metadata$age)
...
We have downloaded the list of genes associated with Parkinson's Disease and we can see if our list of DE genes contains a significant overlap with these genes. 
